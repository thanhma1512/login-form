...
@section('content')
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold text-gray-800">Sửa Bài viết: "{{ $post->title }}"</h1>
            ...
            <form action="{{ route('admin.posts.update', $post) }}" method="POST" enctype="multipart/form-data">
                    ...
                    @if ($post->image)
                        <div class="mb-2">
                            ...
                            <label class="inline-flex items-center mt-2">
                                ...
                                <span class="ml-2 text-sm text-gray-700">Xóa hình ảnh hiện tại</span>
                            </label>
                        </div>
                    @else
                        <p class="text-sm text-gray-500 mb-2">Chưa có hình ảnh nào.</p>
                    @endif
               ...
               <div class="mb-4">
                ...
                <div class="mb-6 flex items-center">
                    ...
                    <label for="is_published" class="ml-2 text-sm text-gray-700">Xuất bản</label>
                </div>
